    ...
    <header className="App-header header-ficha col-xs-12">
      ...
      <div className="fundo">
        <div className="nome col-xs-12">
          <label className="col-xs-3 col-sm-2" htmlFor="nome">
            Nome
          </label>
        ...
        <div className="scale has-feedback">
          ...
          <select
            className=""
            name="pontuacao"
            ng-options="option.name for option in pontuacao.availableOptions track by option.value"
            ng-model="pontuacao.selectedOption"
            required
          />
        </div>
      </div>
